...
API.prototype.seedFromRandom = function(opts) {
  ...
  opts = opts || {};
  this.credentials = Credentials.create(opts.coin || Constants.COINS.AIB, opts.network || 'livenet');
};
...
API.prototype.seedFromRandomWithMnemonic = function(opts) {
  ...
  opts = opts || {};
  this.credentials = Credentials.createWithMnemonic(opts.coin || Constants.COINS.AIB, opts.network || 'livenet', opts.passphrase, opts.language || 'en', opts.account || 0);
};
