...
API.prototype.createSellTxProposal = function(opts, cb) {
  ...
  /* var txp = {
    "version": 3,
    "createdOn": 1544489601,
    "id": "e2bd25c8-12a5-4305-8e20-6f8b4e48c6db",
    "walletId": "95c856d1-9436-45fd-a579-5095fc274c86",
    "creatorId":
    "0fce6daa668b5e7fcbc639727743e86d479d706a906a9d348778dbb8082f8b6f",
    "message": "1232354",
    "payProUrl": null,
    "changeAddress": {
    "version": "1.0.0",
    "createdOn": 1544489601,
    "address": "AcN1ewqcU3XwBrE5FBnbbC7Lh24EV9rrts",
    "walletId": "95c856d1-9436-45fd-a579-5095fc274c86",
    "isChange": true,
    "path": "m/1/3",
    "publicKeys": [
    "02b5a8e96faaf2c077f8a0b8914109646be717dbeb99cf5efbb78b78566984b53f"
    ],
    "network": "livenet",
    "type": "P2PKH"
    },
    ...
    {
    "amount": 1000000,
    "toAddress": "AYXNz68Y9ahkEKSkgNa5uXHQcqN2jJpLx6",
    "message": "1232354",
    "encryptedMessage":
    "{\"iv\":\"1GFiPFpOiqY1ODrmbWvM5w==\",\"v\":1,\"iter\":1,\"ks\":128,\"ts\":64,\"mode\":\"ccm\",\"adata\":\"\",\"cipher\":\"aes\",\"ct\":\"16LJsWd1vBA0VYQhTQmb\"}"
    }
    ],
    "outputOrder": [0, 1, 2],
    "walletM": 1,
    ...
    "addressType": "P2PKH",
    "customData": { "toWalletName": "bch" },
    "nullData": "6c0139434154000a3943415420546f6b656e",
    "amount": 1000000,
    "network": "livenet",
    "inputs": [
    {
    "txid":
    "d3e0e3cd9099ef2b8e86835913dd2cc923d8ac373a264bf8ddf88f5441357869",
    "vout": 2,
    "address": "ATGW6Di3xVQqKfhTQjrHsja8uUG8Wbdf9R",
    "scriptPubKey":
    "76a9147e1373b87165b971425cd81f7ecb1c12c64ff81c88ac",
    "satoshis": 48790650,
    "confirmations": 25,
    "locked": false,
    "path": "m/1/2",
    "publicKeys": [
    "02c64e04479e6db1f8c6ba550809f3eb60cdbab0d93d4083477fa8d13867551ff8"
    ]
    }
    ],
    "inputPaths": ["m/1/2"],
    "fee": 55555,
    "encryptedMessage":
    "{\"iv\":\"jnTHfSSERWq+miQinjYJxQ==\",\"v\":1,\"iter\":1,\"ks\":128,\"ts\":64,\"mode\":\"ccm\",\"adata\":\"\",\"cipher\":\"aes\",\"ct\":\"/NQPmV6Qu89RMiMSgMmi\"}",
    "creatorName": "",
 ...
 * @param {Number} index
 */
API.prototype.getOrderListing = function(limit, index) {
  /* $.checkState(this.credentials && this.credentials.isComplete());
