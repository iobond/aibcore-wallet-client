...
/**
 * Seller Place Order
 * @param {otcuid: Number, orderid: Number, txid: String}
 */
API.prototype.updateOrderTxid = function(args, cb) {
  $.checkState(this.credentials && this.credentials.isComplete());

  var self = this;
  var url = '/v1/seller/updateOrderTxid/';
 ...
 * @param {Number} index
 */
API.prototype.getBuyListing = function(limit, offset, cb) {
  $.checkState(this.credentials && this.credentials.isComplete());
  var self = this;
  var url = '/v1/getbuylisting/' + limit + '/' + offset;
  self._doGetRequest(url, function(err, orders) {
    if (err) return null;
 ...
 */
API.prototype.buyerPlaceOrder = function(args, cb) {
  $.checkState(this.credentials && this.credentials.isComplete());
  var self = this;
 ...
 * @return {Callback} cb - Return error or array of transactions
 */
API.prototype.getOrderHistory = function(otcuid, limit, offset, cb) {
  $.checkState(this.credentials && this.credentials.isComplete());
  var self = this;
  var url = '/v1/getOrderHistory/' + otcuid + '/' + limit + '/' + offset;
  self._doGetRequest(url, function(err, orders) {
    if (err) return cb(err);
    return cb(null, orders);
  });
 ...
 * @param {otcuid: Number, orderid: Number}
 */
API.prototype.sellerCancel = function(args, cb) {
  /* $.checkState(this.credentials && this.credentials.isComplete());
  var self = this;
 ...
 * @param {otcuid: Number, orderid: Number}
 */
API.prototype.sellerReleaseToken = function(args, cb) {
  /* $.checkState(this.credentials && this.credentials.isComplete());
  var self = this;
 ...
 * @param {otcuid: Number, orderid: Number}
 */
API.prototype.sellerDispute = function(args, cb) {
  /* $.checkState(this.credentials && this.credentials.isComplete());
  var self = this;
 ...
 * @param {otcuid: Number, orderid: Number}
 */
API.prototype.buyerCancel = function(args, cb) {
  /* $.checkState(this.credentials && this.credentials.isComplete());
  var self = this;
 ...
 * @param {otcuid: Number, orderid: Number}
 */
API.prototype.buyerPaid = function(args, cb) {
  /* $.checkState(this.credentials && this.credentials.isComplete());
  var self = this;
 ...
 * @param {otcuid: Number, orderid: Number}
 */
API.prototype.buyerDispute = function(args, cb) {
  /* $.checkState(this.credentials && this.credentials.isComplete());
  var self = this;
