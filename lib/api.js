...
API.prototype.createSellTxProposal = function(opts, cb) {
  ...
  self._doPostRequest('/v1/seller/getxp/', args, function(err, txp) {
    if (err) return cb(err);
...
API.prototype.publishSellTxProposal = function(opts, cb) {
  ...
  var url = '/v1/seller/publishtxp/' + opts.txp.id;
  self._doPostRequest(url, args, function(err, txp) {
    if (err) return cb(err);
    self._processTxps(txp);
    return cb(null, txp);
 ...
 * @param {Number} index
 */
API.prototype.getBuyListing = function(limit, index, cb) {
  var self = this;
  var url = '/v1/getbuylisting/' + limit + '/' + index;
  self._doGetRequest(url, function(err, order) {
    if (err) return null;
  ...
  /* var orders = [
    {
      "order_id": 1,
      "suid": 1,
      "seller_reputation": 999,
      "sell_txid": "baba4a74a0f70a241f83605b475be54c43baa69a720d2e9a93c5cbc42a3b41d3",
      "buid": null,
      ...
      "tx_status": "DEPOSITED",
      "order_status": "RELIST",
      "creation_time": 1544597074,
      "payment_info": "E-Transfer: dev1@aib.one",
      "amount_unit": "CADT"
    },
    {
      "order_id": 2,
      "suid": 2,
      "seller_reputation": 998,
      "sell_txid": "baba4a74a0f70a241f83605b475be54c43baa69a720d2e9a93c5cbc42a3b41d3",
      "buid": null,
      "buyer_reputation": null,
      "buyer_addr": null,
      ...
      "tx_status": "DEPOSITED",
      "order_status": "RELIST",
      "creation_time": 1544597194,
      "payment_info": "E-Transfer: dev2@aib.one",
      "amount_unit": "CADT"
    },
    {
      "order_id": 3,
      "suid": 3,
      "seller_reputation": 997,
      "sell_txid": "baba4a74a0f70a241f83605b475be54c43baa69a720d2e9a93c5cbc42a3b41d3",
      "buid": null,
      "buyer_reputation": null,
      "buyer_addr": null,
      ...
      "creation_time": 1544598000,
      "payment_info": "E-Transfer: dev3@aib.one",
      "amount_unit": "CADT"
    },
    {
      "order_id": 4,
      "suid": 4,
      "seller_reputation": 996,
      "sell_txid": "baba4a74a0f70a241f83605b475be54c43baa69a720d2e9a93c5cbc42a3b41d3",
      "buid": null,
      "buyer_reputation": null,
      "buyer_addr": null,
...
/**
 * Buyer Place Order
 * @param {otcuid: Number, orderid: Number}
 */
API.prototype.buyerPlaceOrder = function(args) {
  var self = this;
  var url = '/v1/buyer/placeorder/';
  self._doPostRequest(url, args, function(err, order) {
    if (err) return null;
    return order;
  });
  ...
  /* var order = {
    ...
    "sell_txid": "baba4a74a0f70a241f83605b475be54c43baa69a720d2e9a93c5cbc42a3b41d3",
    "buid": 8,
    "buyer_reputation": 999,
    "buyer_addr": "AQdER6An945Dyg5GRKy53W1HNTrvgqiXpU",
    "buy_txid": null,
    "amount": 10000000000,
    "fee": 5500000,
    "action": "BUYING",
 ...
 * @return {Callback} cb - Return error or array of transactions
 */
API.prototype.getOrderHistory = function(opts, cb) {
  $.checkState(this.credentials && this.credentials.isComplete());
  ...
  /* var orders =  [
    {
      ...
      "buyer_reputation": 999,
      "buyer_addr": "AQdER6An945Dyg5GRKy53W1HNTrvgqiXpU",
      "buy_txid": "06728fe8043ec7d64047f4fbbfbedb67405224bc3466f45f02ff43d978b84b00",
      "amount": 2500000000,
      "fee": 5500000,
      "action": "SOLD",
      "tx_status": "SENT",
 ...
 * @param {otcuid: Number, orderid: Number}
 */
API.prototype.sellerCancel = function(args) {
  /* $.checkState(this.credentials && this.credentials.isComplete());
  var self = this;
  var url = '/v1/seller/cancel/';
  self._doPostRequest(url, args, function(err, order) {
    if (err) return null;
    return order;
  }); */
  ...
  var order = {
    ...
    "creation_time": 1544698312,
    "payment_info": "E-Transfer: dev5@aib.one",
    "amount_unit": "CADT"
  }
...
/**
 * Seller Release Order
 * @param {otcuid: Number, orderid: Number}
 */
API.prototype.sellerReleaseToken = function(args) {
  /* $.checkState(this.credentials && this.credentials.isComplete());
  var self = this;
  var url = '/v1/seller/releasetoken/';
  self._doPostRequest(url, args, function(err, order) {
    if (err) return null;
    return order;
  }); */
  ...
  var order = {
    ...
    "action": "SELLING",
    "tx_status": "DEPOSITED",
    "order_status": "SELLER_RELEASE",
    "creation_time": 1545598312,
    "payment_info": "E-Transfer: dev6@aib.one",
    "amount_unit": "CADT"
  }
 ...
 * @param {otcuid: Number, orderid: Number}
 */
API.prototype.sellerDispute = function(args) {
  /* $.checkState(this.credentials && this.credentials.isComplete());
  var self = this;
  var url = '/v1/seller/dispute/';
  self._doPostRequest(url, args, function(err, order) {
    if (err) return null;
    return order;
  }); */
  ...
  var order = {
    ...
    "action": "SELLING",
    "tx_status": "HOLDING",
    "order_status": "SELLER_DISPUTE",
    "creation_time": 1546698312,
    "payment_info": "E-Transfer: dev7@aib.one",
    "amount_unit": "CADT"
  }
 ...
 * @param {otcuid: Number, orderid: Number}
 */
API.prototype.buyerCancel = function(args) {
  /* $.checkState(this.credentials && this.credentials.isComplete());
  var self = this;
  var url = '/v1/buyer/cancel/';
  self._doPostRequest(url, args, function(err, order) {
    if (err) return null;
    return order;
  }); */
  ...
  var order = {
    ...
    "tx_status": "DEPOSITED",
    "order_status": "RELIST",
    "creation_time": 1546798312,
    "payment_info": "E-Transfer: dev8@aib.one",
    "amount_unit": "CADT"
  }
 ...
 * @param {otcuid: Number, orderid: Number}
 */
API.prototype.buyerPaid = function(args) {
  /* $.checkState(this.credentials && this.credentials.isComplete());
  var self = this;
  var url = '/v1/buyer/setpaid/';
  self._doPostRequest(url, args, function(err, order) {
    if (err) return null;
    return order;
  }); */
  ...
  var order = {
    ...
    "action": "BUYING",
    "tx_status": "DEPOSITED",
    "order_status": "BUYER_PAID",
    "creation_time": 1546898312,
    "payment_info": "E-Transfer: dev9@aib.one",
    "amount_unit": "CADT"
  }
 ...
 * @param {otcuid: Number, orderid: Number}
 */
API.prototype.buyerDispute = function(args) {
  /* $.checkState(this.credentials && this.credentials.isComplete());
  var self = this;
  var url = '/v1/buyer/dispute/';
  self._doPostRequest(url, args, function(err, order) {
    if (err) return null;
    return order;
  }); */
  ...
  var order = {
    ...
    "action": "BUYING",
    "tx_status": "HOLDING",
    "order_status": "BUYER_DISPUTE",
    "creation_time": 1546998312,
    "payment_info": "E-Transfer: dev10@aib.one",
    "amount_unit": "CADT"
  }
